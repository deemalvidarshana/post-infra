...
namespace Smapi.API.Migrations
{
    ...
    [Migration("20260703085643_AddFacebookStoryPublishingToReelJobs")]
    partial class AddFacebookStoryPublishingToReelJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smapi.API.Models.FacebookAutoReplySetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("IgnoreKeywords")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
                    ...
                    b.Property<int>("MaxRepliesPerPostPerDay")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("FacebookAutoReplySettings");
                });

            modelBuilder.Entity("Smapi.API.Models.FacebookCommentEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PageId", "CommentId")
                        .IsUnique();

                    b.HasIndex("UserId", "PageId", "ReceivedAt");
            ...
            modelBuilder.Entity("Smapi.API.Models.FacebookPostUrl", b =>
                {
                    ...
                    b.HasIndex("UserId", "PageId", "Platform");

                    b.HasIndex("UserId", "PageId", "Platform", "PermalinkUrl")
                        .IsUnique();
            ...
            modelBuilder.Entity("Smapi.API.Models.FacebookReelUploadJob", b =>
                {
                    ...
                    b.Property<string>("FacebookStoryId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.Property<bool>("PublishAsStory")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("StoryErrorMessage")
                        .HasColumnType("text");

                    b.Property<DateTime?>("StoryPublishedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Smapi.API.Models.GeminiSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
